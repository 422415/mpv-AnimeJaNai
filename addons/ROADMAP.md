...
| Sessions | Native provider, approved local sources/profiles, admission, asynchronous open/close, independent pause/seek, persistent host capacity UI, real concurrent DirectML tests | TensorRT/RIFE validation, more source types and hardware matrix |
